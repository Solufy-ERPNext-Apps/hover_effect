(() => {
  ...
  $(document).ready(function() {
    ...
    $(document).on("mouseenter", "a.filterable.ellipsis", function(e) {
      ...
      if (!docname || current_hovered === docname)
        return;
    ...
    function show_hover_popover(doctype, name) {
      ...
      $hover_popover.removeClass("hidden").html(`<div class="hover-header"><div class="hover-title">${frappe.utils.escape_html(doctype)}: <span class="hover-docname">${frappe.utils.escape_html(name)}</span></div><button class="hover-close" title="Close">&#x2715;</button></div><div class="hover-loading"><div class="hover-spinner"></div><span>Loading\u2026</span></div>`);
      frappe.call({
    ...
    function render_popover_content(data, doctype, name) {
      ...
      if ((_a = data.items) == null ? void 0 : _a.length) {
        ...
        items_html = `<div class="hover-section"><div class="hover-section-title">Items</div>
          ...
          return `<tr>
                        ...
                        <td class="num">${(_a2 = i.qty) != null ? _a2 : "\u2014"}</td>
      ...
      let gl_html = "";
      if ((_b = data.gl_entries) == null ? void 0 : _b.length) {
        let td = 0, tc = 0;
      ...
      let accounts_html = "";
      if (doctype === "Payment Entry" && ((_c = data.accounts) == null ? void 0 : _c.length)) {
